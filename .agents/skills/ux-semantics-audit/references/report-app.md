...
```
node .agents/skills/ux-semantics-audit/report/build.mjs           # -> report/dist-report/index.html
node .agents/skills/ux-semantics-audit/report/build.mjs --dev     # dev server, localhost:3300
...
- `node .agents/skills/ux-semantics-audit/report/typecheck.mjs`
- `biome check .agents/skills/ux-semantics-audit/report`
