// The Rome agent's avatar. Shape taken from an existing in-system asset
// (`packages/app-template/template/src/assets/icon.svg` — the Rome mark drawn as
// a robot head with two eyes), but recoloured onto theme tokens instead of the
// asset's hard-coded slate/grey: the tile is `--surface-muted` (the exact
// background the surrounding app-icon avatars sit on) and the mark is
// `--foreground`, so the avatar matches its neighbours and tracks light/dark.
import type { SVGProps } from "react";

export function RomeAvatar(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="52"
      height="52"
      ...
      {...props}
    >
      <rect width="52" height="52" rx="12" fill="var(--surface-muted)" />
      <g transform="translate(6 7.38) scale(0.784)" fill="var(--foreground)">
        ...
        <path
          d="M13.5613 6.47284L15.7849 25.1512C16.0244 27.1632 17.7306 28.6784 19.7568 28.6784H44.6983C47.1437 28.6784 49.0167 26.5036 48.6541 24.0853L45.8536 5.40689C45.56 3.4487 43.8779 2 41.8978 2H17.5333C15.1367 2 13.278 4.09306 13.5613 6.47284Z"
        ...
        />
        <path
          d="M35.2279 11.8394H38.2279L36.6069 15.2237L39.2279 18.8394H36.2279L33.8544 15.2237L35.2279 11.8394Z"
          stroke="var(--foreground)"
          strokeWidth="2"
          strokeLinejoin="round"
        />
        <path
          d="M25.5321 11.8394H28.5321L29.5321 18.8394H26.5321L25.5321 11.8394Z"
          stroke="var(--foreground)"
          strokeWidth="2"
          strokeLinejoin="round"
        />
